...
namespace Bluetask.ViewModels
{
    public partial class SettingsViewModel : ObservableObject
    {
        ...
        [ObservableProperty]
        private bool _advancedMonitoring = SettingsService.AdvancedMonitoring;
        ...
        partial void OnAdvancedMonitoringChanged(bool value)
        {
            SettingsService.AdvancedMonitoring = value;
        }

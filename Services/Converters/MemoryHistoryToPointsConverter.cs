...
{
    public class MemoryHistoryToPointsConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            try
            {
                ...
                // Use larger dimensions for the main Memory chart
                double width = 600; // Adjusted for larger chart area
                double height = 300; // Adjusted for larger chart area
                double maxValue = 100.0; // Memory percentage max is always 100%
            ...
            {
                System.Diagnostics.Debug.WriteLine($"MemoryHistoryToPointsConverter error: {ex.Message}");
                return new PointCollection();
            }
        }

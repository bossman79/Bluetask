...
{
    public class GpuHistoryToPointsConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            try
            {
                ...
                // Use larger dimensions for the main GPU chart
                double width = 600; // Adjusted for larger chart area
                double height = 300; // Adjusted for larger chart area
                double maxValue = 100.0; // GPU utilization percentage max is always 100%
            ...
            {
                System.Diagnostics.Debug.WriteLine($"GpuHistoryToPointsConverter error: {ex.Message}");
                return new PointCollection();
            }
        }
